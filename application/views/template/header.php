...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <!-- Favicons -->
  <link href="asset/dis/img/logokemenag.png" rel="icon">
  <link href="asset/dis/img/logokemenag.png" rel="apple-touch-icon">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>SPK Beasiswa Al Amanah</title>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@100..900&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
</head>
