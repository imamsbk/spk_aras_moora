    ...
    <section class="content">
     ...
     <div class="row">
       <div class="box">
        ...
        $nomor = 0;
        $tahun = $_GET['t'];;
        $query = $this->db->query("select * from tabel_ranking inner join tabel_siswa on tabel_ranking.nisn=tabel_siswa.nisn where tabel_ranking.tahun='$tahun' order by tabel_ranking.nilai DESC")->result();
        ...
        foreach ($query as $data) {
              ...
              <tr>
                ...
                <td><?php if($nomor == 1){ echo "Terpilih sebagai Siswa penerima beasiswa berprestasi"; } ?></td>
              </tr>
